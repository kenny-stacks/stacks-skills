...
must_haves:
  truths:
    - "Developer can write unit tests for Clarity contracts using documented patterns"
...
Include TypeScript code examples with Vitest, simnet API, and custom matchers (toBeOk, toBeErr) showing collaborative test workflow output.
...
- Include TypeScript test example showing simnet.mineBlock(), tx.callPublicFn(), and response matchers
